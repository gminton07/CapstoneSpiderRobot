...
## NOTE when ran robot walks forward with no controller or sensor consideration.

class GoSteppy(Node): # nodes are class objects, what defines it
    def __init__(self): # when create class, automatically runs on class creation
        super().__init__('GoSteppy')
